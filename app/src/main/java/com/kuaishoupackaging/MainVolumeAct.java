...
public class MainVolumeAct extends BaseAct implements WeightInterface.DisplayWeightDatasListener, VolumeInterface.DisplayVolumeListener, CustomToolBar.BtnClickListener, DecodeResultListener {
...
//        customToolBar.setCameraState("相机：已连接");
        ...
        mVolueLayout.setVisibility(View.VISIBLE);
        try {
...
//        startSocket();
        ...
        volumeInterface.initVolumeCamera(MainVolumeAct.this, mSurfaceview);
...
//                    dbUitl.insertDtata(new KuaiShouDatas((String) msg.obj, weightResult + "kg", String.valueOf(R.string.volume_l) + 10 + String.valueOf(R.string.volume_w) + 10 + String.valueOf(R.string.volume_h) + 10, testTime(System.currentTimeMillis())));
                    dbUitl.insertDtata(new KuaiShouDatas((String) msg.obj, weightResult + "kg", String.valueOf(R.string.volume_l) + volumeDatas[0] + String.valueOf(R.string.volume_w) + volumeDatas[1] + String.valueOf(R.string.volume_h) + volumeDatas[2], testTime(System.currentTimeMillis())));
//                    final Gson gson = new GsonBuilder().serializeNulls().create();
...
//                hsmDecoder.enableSymbology(Symbology.QR);
    ...
    public void startSocket() {
        tcpIpUtils = new TcpIpUtils(handler, MainVolumeAct.this);
        tcpIpUtils.startss();
